...
EXPIRY_DATES = {
    ...
    2028: {3: 14, 5: 12, 7: 14, 10: 13},
    2029: {3: 14, 5: 14, 7: 13, 10: 12},

    # ===== RULEBOOK-CONSISTENT (CME methodology) =====
    2030: {3: 14, 5: 14, 7: 12, 10: 14},
    2031: {3: 14, 5: 14, 7: 14, 10: 14},
    2032: {3: 12, 5: 14, 7: 14, 10: 14},
    2033: {3: 14, 5: 13, 7: 14, 10: 14},
    2034: {3: 14, 5: 12, 7: 14, 10: 13}
}
...
def single_delta(instrument_type, expiry, F_market, K, v, T, qty, contract_multiplier=1.0):
    ...
    - contract_multiplier : the notional value of the contract which is of 112 000 on SB 
...
def compute_line_thetas(
    ...
    """
    Theta computation for each line of the portfolio (USD / day).
    """
    def theta_row(row):
        return single_theta(
            instrument_type=row[col_type],
